...
export function createDeepSeekHostPlugin({ boundary, identity, resolveIntent, onError, shutdownResultWaitMs } = {}) {
  ...
  return {
    ...
    apply(ctx) {
      ...
      const mounted = installDeepSeekObserver(ctx, { boundary, identity, resolveIntent, onError, shutdownResultWaitMs });
      observer = mounted;
